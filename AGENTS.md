...
The lint gates check Sources/ for the repo's shared SwiftLint, format, dead-code, and swiftcheck rules. They must exit clean before any commit that touches Swift files.
